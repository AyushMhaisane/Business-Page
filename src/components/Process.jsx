...
const steps = [
    ...
    },
    {
        ...
        description: "We create a clean structure and wireframe tailored to your specific needs.",
        icon: <PenTool className="w-6 h-6 text-white" />,
    },
    {
        id: 3,
        title: "Development",
        description: "We build your site using modern tech (React/Tailwind) ensuring it's fast and mobile-ready.",
        icon: <Code className="w-6 h-6 text-white" />,
    },
    {
        id: 4,
        title: "Launch & Support",
        description: "We go live! We also provide a guide on how to manage your new digital asset.",
